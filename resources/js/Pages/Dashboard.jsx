...
export default function Dashboard(props) {
    ...
    return (
        <AuthenticatedLayout
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Berita Terkini</h2>}
        >
            ...
            <div className="py-12">
                    ...
                    <div className="p-6 bg-white border-b border-gray-200">
                        {isNotif && <div role="alert" className="alert alert-info">
                            <div>
                                ...
                                strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                ...
                <div className='p-4'>
                    {/* {console.log('ini php', props)} */}
                    {props.myNews && props.myNews.length > 0 ? props.myNews.map((news, i) => {
                        return (
                            <div key={i} className="card w-full lg:w-96 bg-base-100 w-96 shadow-xl m-2">
